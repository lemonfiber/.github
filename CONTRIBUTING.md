...
Every commit to an implementation repo — every repository in the org besides
`spec`, this one included — references a spec identifier (a requirement like
`A2-R4`, an `ADR-0006`, or a governance rule like `GOV-R12`), and that identifier
must already be merged in the spec.
